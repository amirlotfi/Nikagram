...
import ir.nikagram.messenger.audioinfo.AudioInfo;
import ir.nikagram.ui.LaunchActivity;

public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {

    public static final String NOTIFY_PREVIOUS = "ir.nikagram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.nikagram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.nikagram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.nikagram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.nikagram.android.musicplayer.next";
