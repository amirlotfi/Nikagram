 ...
 */
package ir.nikagram.messenger.exoplayer.extractor.mp4;
...
import ir.nikagram.messenger.exoplayer.extractor.SeekMap;
import ir.nikagram.messenger.exoplayer.extractor.TrackOutput;
import ir.nikagram.messenger.exoplayer.extractor.mp4.Atom.ContainerAtom;
import ir.nikagram.messenger.exoplayer.extractor.mp4.Atom.LeafAtom;
import ir.nikagram.messenger.exoplayer.util.Assertions;
import ir.nikagram.messenger.exoplayer.util.MimeTypes;
import ir.nikagram.messenger.exoplayer.util.NalUnitUtil;
      ...
      if (child.type == Atom.TYPE_pssh) {
        ...
        if (uuid == null) {
          ...
          drmInitData.put(PsshAtomUtil.parseUuid(psshData),
              new DrmInitData.SchemeInitData(MimeTypes.VIDEO_MP4, psshData));
        }
      }
    }
    if (drmInitData != null) {
