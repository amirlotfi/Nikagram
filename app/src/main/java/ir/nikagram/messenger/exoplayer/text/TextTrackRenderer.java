 ...
 */
package ir.nikagram.messenger.exoplayer.text;
...
import ir.nikagram.messenger.exoplayer.ExoPlaybackException;
...
import ir.nikagram.messenger.exoplayer.SampleSourceTrackRenderer;
...
import ir.nikagram.messenger.exoplayer.text.subrip.SubripParser;
import ir.nikagram.messenger.exoplayer.text.ttml.TtmlParser;
import ir.nikagram.messenger.exoplayer.text.tx3g.Tx3gParser;
import ir.nikagram.messenger.exoplayer.text.webvtt.WebvttParser;
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.nikagram.messenger.exoplayer.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.nikagram.messenger.exoplayer.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.nikagram.messenger.exoplayer.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.nikagram.messenger.exoplayer.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.nikagram.messenger.exoplayer.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
