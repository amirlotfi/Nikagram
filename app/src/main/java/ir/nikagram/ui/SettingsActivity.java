...
import ir.nikagram.ui.Cells.TextInfoCell;
import ir.nikagram.ui.Cells.EmptyCell;
import ir.nikagram.ui.Cells.HeaderCell;
import ir.nikagram.ui.Cells.ShadowSectionCell;
import ir.nikagram.ui.Cells.TextCheckCell;
import ir.nikagram.ui.Cells.TextDetailSettingsCell;
...
import ir.nikagram.ui.Components.NumberPicker;
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "Nikagram For Android V%s (%d) %s", pInfo.versionName, code, abi));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                    break;
