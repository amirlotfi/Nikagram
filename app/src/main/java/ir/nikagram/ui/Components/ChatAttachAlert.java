...
import ir.nikagram.ui.Cells.PhotoAttachCameraCell;
import ir.nikagram.ui.Cells.PhotoAttachPhotoCell;
import ir.nikagram.ui.Cells.ShadowSectionCell;
import ir.nikagram.ui.ChatActivity;
...
import ir.nikagram.messenger.camera.CameraController;
import ir.nikagram.messenger.camera.CameraView;
    ...
    public ChatAttachAlert(Context context, final ChatActivity parentFragment) {
        ...
        containerView = listView = new RecyclerListView(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(Math.min(contentSize, height), View.MeasureSpec.EXACTLY));
            }
