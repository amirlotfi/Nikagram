...
public class Switch extends CompoundButton {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mTrackDrawable != null) {
            mTrackDrawable.setColorFilter(new PorterDuffColorFilter(checked ? 0xffB4FAA0 : 0xffc7c7c7, PorterDuff.Mode.MULTIPLY));
        }
        if (mThumbDrawable != null) {
            mThumbDrawable.setColorFilter(new PorterDuffColorFilter(checked ? 0xff6AEF45 : 0xffededed, PorterDuff.Mode.MULTIPLY));
        }
    }
