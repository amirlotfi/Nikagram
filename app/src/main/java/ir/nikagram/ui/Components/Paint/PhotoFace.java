package ir.nikagram.ui.Components.Paint;
...
public class PhotoFace {
    ...
    private ir.nikagram.ui.Components.Point foreheadPoint;

    private ir.nikagram.ui.Components.Point eyesCenterPoint;
    private float eyesDistance;

    private ir.nikagram.ui.Components.Point mouthPoint;
    private ir.nikagram.ui.Components.Point chinPoint;

    public PhotoFace(Face face, Bitmap sourceBitmap, Size targetSize, boolean sideward) {
        List<Landmark> landmarks = face.getLandmarks();

        ir.nikagram.ui.Components.Point leftEyePoint = null;
        ir.nikagram.ui.Components.Point rightEyePoint = null;

        ir.nikagram.ui.Components.Point leftMouthPoint = null;
        ir.nikagram.ui.Components.Point rightMouthPoint = null;
        ...
        if (leftEyePoint != null && rightEyePoint != null) {
            eyesCenterPoint = new ir.nikagram.ui.Components.Point(0.5f * leftEyePoint.x + 0.5f * rightEyePoint.x,
            ...
            foreheadPoint = new ir.nikagram.ui.Components.Point(eyesCenterPoint.x + foreheadHeight * (float)Math.cos(upAngle),
                    eyesCenterPoint.y + foreheadHeight * (float)Math.sin(upAngle));
        }

        if (leftMouthPoint != null && rightMouthPoint != null) {
            mouthPoint = new ir.nikagram.ui.Components.Point(0.5f * leftMouthPoint.x + 0.5f * rightMouthPoint.x,
            ...
            chinPoint = new ir.nikagram.ui.Components.Point(mouthPoint.x + chinDepth * (float)Math.cos(downAngle),
    ...
    private ir.nikagram.ui.Components.Point transposePoint(PointF point, Bitmap sourceBitmap, Size targetSize, boolean sideward) {
        ...
        return new ir.nikagram.ui.Components.Point(targetSize.width * point.x / bitmapW,
                targetSize.height * point.y / bitmapH);
    }

    public ir.nikagram.ui.Components.Point getPointForAnchor(int anchor) {
        switch (anchor) {
            case 0: {
