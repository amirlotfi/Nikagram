...
import ir.nikagram.Nika.Helper.GhostPorotocol;
import ir.nikagram.Nika.Helper.NotiFicationMaker;
...
import ir.nikagram.messenger.DialogObject;
import ir.nikagram.messenger.FileLog;
import ir.nikagram.messenger.ImageLoader;
...
import ir.nikagram.ui.ActionBar.MenuDrawable;
import ir.nikagram.ui.ActionBar.Theme;
import ir.nikagram.ui.Adapters.DialogsAdapter;
import ir.nikagram.ui.Adapters.DialogsSearchAdapter;
import ir.nikagram.ui.Cells.DialogCell;
import ir.nikagram.ui.Cells.HintDialogCell;
import ir.nikagram.ui.Cells.ProfileSearchCell;
import ir.nikagram.ui.Cells.UserCell;
import ir.nikagram.ui.Components.EmptyTextProgressView;
...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        final ActionBarMenuItem autoanswermenu = menu.addItem(4, (Setting.getAnsweringMachine() ? R.drawable.ic_auto_answer : R.drawable.ic_auto_answer_disable));
        final ActionBarMenuItem ghostmenu = menu.addItem(6, (Setting.getGhostMode() ? R.drawable.ic_ghost : R.drawable.ic_ghost_disable));
        ...
        ghostmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Setting.getGhostMode()) {
                    ...
                    Toast.makeText(context, "حالت روح غیرفعال شد", Toast.LENGTH_LONG).show();
                } else {
                    ghostmenu.setIcon(R.drawable.ic_ghost);
                    GhostPorotocol.trun(true);
                    Toast.makeText(context, "حالت روح فعال شد", Toast.LENGTH_LONG).show();
                }
            }
        });

        autoanswermenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Setting.setAnsweringMachine(!Setting.getAnsweringMachine());
                if (Setting.getAnsweringMachine()) {
                    autoanswermenu.setIcon(R.drawable.ic_auto_answer);
                    NotiFicationMaker.createNotificationAnswer();
                    Toast.makeText(context, LocaleController.getString("answeringmachineisactive", R.string.answeringmachineisactive), Toast.LENGTH_LONG).show();
                } else {
                    autoanswermenu.setIcon(R.drawable.ic_auto_answer_disable);
                    NotiFicationMaker.cancelNotificationAnswer();
                    Toast.makeText(context, LocaleController.getString("answeringmachineisinactive", R.string.answeringmachineisinactive), Toast.LENGTH_LONG).show();
                }
            }
        });
