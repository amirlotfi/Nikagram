...
static const char *FileLoadOperationClassPathName = "ir/nikagram/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "ir/nikagram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ir/nikagram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILir/nikagram/tgnet/RequestDelegateInternal;Lir/nikagram/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ir/nikagram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/nikagram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/nikagram/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ir/nikagram/tgnet/ConnectionsManager"));
